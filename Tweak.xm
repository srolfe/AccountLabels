...
@implementation ColorPickerViewController
	- (void)viewDidLoad{
		...
		// Add picker "window"
		CGRect *pickWinFrame=CGRectMake(self.view.frame.origin.x-20, self.view.frame.origin.y-20, self.view.frame.origin.x-20)
		UIView *pickWin=[[UIView alloc] initWithFrame]
	}
